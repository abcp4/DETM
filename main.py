...
parser.add_argument('--batch_size', type=int, default=32, help='number of documents in a batch for training')
...
parser.add_argument('--eval_batch_size', type=int, default=32, help='input batch size for evaluation')
